...
function explodeOne(number: Pair) {
	const stack: [SnailNumeral, "left" | "right" | "done"][] = [[number, "left"]];
...
assertEquals(explodeOne([[[[[9, 8], 1], 2], 3], 4]), [[[[0, 9], 2], 3], 4]);
assertEquals(explodeOne([7, [6, [5, [4, [3, 2]]]]]), [7, [6, [5, [7, 0]]]]);
assertEquals(explodeOne([[6, [5, [4, [3, 2]]]], 1]), [[6, [5, [7, 0]]], 3]);
assertEquals(
	explodeOne([
		[3, [2, [1, [7, 3]]]],
		[6, [5, [4, [3, 2]]]],
